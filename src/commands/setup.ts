...
export const handler = async (_argv: Arguments<SetupOptions>) => {
  ...
  logger.log('   • GitHub Issues: https://github.com/gfargo/doorman/issues')
  ...
  logger.log(chalk.dim('Run: ') + chalk.cyan('doorman init --interactive'))
  logger.log('')
}
